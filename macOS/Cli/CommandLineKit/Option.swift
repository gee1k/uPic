...
public class Option {
    ...
    init(_ shortFlag: String?, _ longFlag: String?, _ required: Bool, _ helpMessage: String) {
        if let sf = shortFlag {
...
public class EnumOption<T: RawRepresentable>: Option where T.RawValue == String {
    ...
    override init(_ shortFlag: String?, _ longFlag: String?, _ required: Bool, _ helpMessage: String) {
